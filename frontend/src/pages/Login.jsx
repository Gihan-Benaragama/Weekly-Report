            ...
            <div className="w-full md:w-1/2 flex items-center justify-center p-6 sm:p-12 z-10 relative">
                ...
                >
                    ...
                    <button
                        ...
                        disabled={loading}
                        className="glass-btn w-full gap-3 bg-teal-500/10 border border-teal-500/30 text-teal-300 hover:bg-teal-500/20 hover:border-teal-500/60 shadow-lg shadow-teal-500/5 hover:shadow-teal-500/10 disabled:opacity-50 transition-all duration-200"
                    >
                        <svg className="w-4 h-4 flex-shrink-0" viewBox="0 0 24 24" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z" fill="#5eead4" />
                            <path d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.06H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.94l2.85-2.22.81-.63z" fill="#5eead4" />
                            <path d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.06l3.66 2.84c.87-2.6 3.3-4.52 6.16-4.52z" fill="#5eead4" />
                        </svg>
                        Google
                    </button>
